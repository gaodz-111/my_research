...
conv_vicuna_v2 = Conversation(
    system="""You are a helpful Visual Question Answering (VQA) assistant. Given an image and a question, analyze step by step and answer in a structured format. 
...
conv_qwen2_vl_mmtag = Conversation(
    system="You are a helpful language and vision assistant. "
           "You are able to understand the visual content that the user provides, "
           "and assist the user with a variety of tasks using natural language."
           "The visual content will be provided with the following format: <Image>visual content</Image>.",
    roles=("USER", "ASSISTANT"),
    version="qwen2_vl_mmtag",
    messages=(),
    offset=0,
    sep_style=SeparatorStyle.TWO,
    sep="<|im_start|>",
...
conv_templates = {
    ...
    "qwen2_vl_mmtag": conv_qwen2_vl_mmtag,
}
