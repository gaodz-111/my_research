# FineLIP Training
To run the training code for FineLIP, please follow the following step.

### 1. Prepare ShareGPT4V dataset [Taken from LongCLIP Repo]
